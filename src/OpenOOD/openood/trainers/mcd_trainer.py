    ...
    def train_epoch(self, epoch_idx):
        ...
        for train_step in tqdm(
            ...
            if epoch_idx < self.epoch_ft:
                ...
                loss = F.cross_entropy(logits1, batch["label"].cuda()) + F.cross_entropy(logits2, batch["label"].cuda())
                ...
                loss = F.cross_entropy(logits1_id, batch["label"].cuda()) + F.cross_entropy(
                    logits2_id, batch["label"].cuda()
                )
